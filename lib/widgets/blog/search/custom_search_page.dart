...
Future<T> showSearch<T>({
  ...
  return Navigator.of(context).push(CustomSearchPage<T>(
    delegate: delegate,
  ));
}

class CustomSearchPage<T> extends PageRoute<T> {
  CustomSearchPage({
    ...
    switch (widget.delegate._currentBody) {
      ...
      case _SearchBody.results:
        body = KeyedSubtree(
          ...
          child: widget.delegate.buildResults(
            context,
          ),
        );
        break;
    }
    String routeName = Platform.isIOS ? '' : searchFieldLabel;
